...
class MainLayananLayoutSecurity extends StatefulWidget {
  final Widget body;
  final String title;
  final VoidCallback? onBack;
  final String? token;

  const MainLayananLayoutSecurity({
    super.key,
    required this.body,
    required this.title,
    this.onBack,
  ...
  @override
  State<MainLayananLayoutSecurity> createState() => _MainLayananLayoutSecurityState();
}

class _MainLayananLayoutSecurityState extends State<MainLayananLayoutSecurity> {
  String? _userPhoto;
