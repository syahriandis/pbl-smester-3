...
class LayananSuratSecurityPage extends StatefulWidget {
  const LayananSuratSecurityPage({super.key});

  @override
  State<LayananSuratSecurityPage> createState() => _LayananSuratSecurityPageState();
}

class _LayananSuratSecurityPageState extends State<LayananSuratSecurityPage> {
    ...
    return MainLayananLayoutSecurity(
      ...
      body: Stack(
        children: [
          ...
          // FAB tetap ada karena security boleh tambah surat
          Positioned(
            bottom: 16,
            right: 16,
