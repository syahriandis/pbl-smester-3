  ...
  Future<void> _bayarSemua() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text("Apakah Anda yakin ingin membayar semua iuran bulan ini?"),
        actions: [
  ...
  Future<void> _bayarSatu(Map<String, dynamic> tagihan) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text("Apakah Anda yakin ingin membayar iuran ${tagihan["nama"]}?"),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context, false), child: const Text("Batal")),
          TextButton(onPressed: () => Navigator.pop(context, true), child: const Text("Bayar")),
        ],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Rp${tagihan['jumlah']}", style: const TextStyle(color: Colors.grey)),
                ...
                child: Column(
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: (isLoadingSemua || semuaLunas) ? null : _bayarSemua,
